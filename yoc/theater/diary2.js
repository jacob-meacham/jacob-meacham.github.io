...
`
    ...
    date: '9/28',
    text: `OK, I said I wasn't going to write about the play, but there was some drama today, and rereading my entry on Monday put me to sleep. Vicky and Conner just don't have good chemistry together. Neither of them are really that bad (well, Vicky...), but on stage it's painful to watch them. Sometimes, Paula has me read lines with Conner so that she can spend some time with Vicky, and I get the feeling that she'd switch me in for Eliza if she could. Anyway, she got fed up with a scene in the parlor and changed it so that now it’s two half monologues. It's still awkward, but I thought it went better than when they were speaking. Vicky didn't think so though and excused herself for a while.

Vicky didn't come out to happy hour tonight, so instead of tweaking her nose with John, I ended up spending the time talking with Conner and Paula about theater. They both said that the important thing was the show and that the relationships were driven by building something, rather than the other way around.
`
}, {
    date: '9/29',
    text: `I think they're wrong about theater. The play is meaningless. Maybe Paula was on Broadway, but for the rest of us, the only people who are going to come see the show are kind of weird people like Donna, the lady who runs refreshments, or people who are only coming to show support, like Asher. Paula even sort of said that the reason she made Vicky Eliza instead of me was because the play was so important to her. I would have done a great job as Eliza, but being Mrs. Pearce is fine because I can spend time at rehearsal twice a week.
`
}, {
    date: '10/1',
    text: `We weren't running scenes with me or Pickering today, so Rich and I ended up talking a lot. He told me that his company was going to up his donation to help us make up the shortfall. I thought it was really nice, especially since he doesn't really hang around the rest of us. Later, though, John joked that Rich makes a really good Colonel Pickering, going on about his money, and did a parody of him, stuffy English accent and all. I'm not sure about John sometimes. He can be really nice, and I look forward to seeing him every week, but...

Tomorrow we're performing a scene at the library to drum up support for the show. Wish me luck, diary!
`
}, {
    date: '10/2',
    text: `Wow.
...
`
    ...
    date: '10/3',
    text: `Asher and I got in a fight today. He asked why I keep doing community theater when all I seem to do is complain about it to him. I told him that I liked the friendships I'd made, and that I'd even said so in the article I'd pasted on the fridge, except I'd forgotten that I'd taken it down. He responded that it didn't really seem like I had made many friends, and that I complained about pretty much everyone there. I said something pretty mean that I don't want to write down, and he left. Now I have to eat this whole pizza by myself.
`
}, {
    date: '10/4',
    ...
    date: '10/5',
    text: `We actually got some pretty great news today! Donna works at a bakery, I guess (I never really thought about where the concession stand's baked goods came from), and she said that they'd be willing to make up the donation shortfall if we printed their name in the playbill and put them as a major sponsor on any more flyers we were going to put up. Everyone was really excited and Paula kept giving us hugs. It's not totally clear that we'll be able to do our second performance, but it seems a lot more likely now.
...
Paula gave a really weird pep talk about how, sometimes people fail and that's ok, but we shouldn't be those people and besides, our whole community was counting on us for this play. All I could think about the whole time was how often she kept clearing her throat and drumming her fingers on her coffee cup. I've rarely seen her take a sip from it, but it's got to be so cold all the time. Anyway, her speech was too grandiose and a bit demotivating but in a weird way helped, I think? At least, everyone seemed a bit happier afterwards, myself included. I'm not too sure why - maybe it was just the fact that we all sat there together and listened to her for 20 minutes.
`
}, {
    date: '10/12',
...
`
    ...
    date: '10/13',
    text: `Gah! We did a TV spot on the local news about the play tomorrow. They filmed a bit of our rehearsal (more on that later) and did some interviews with each of us. I don't know if my interview aired, and I never will because I asked Asher to tape it but he didn't. He's the one that doesn't care about my play.

The dress rehearsal was a mess. The lighting still wasn't done and we're having all sorts of technical difficulties. My microphone kept cutting out, so we had to redo a scene three different times while I waited for Kevin to work the issues out. At the very beginning, we couldn't even get the curtain to open. I'm not usually too superstitious, but that's a bad omen if ever there was one. Even with all the issues though, Vicky and I actually had a lot of fun together tonight. Our scenes went really well and while we were waiting for our interview slots with the TV crew, she told me about hoe she always got nervous and excited the day before opening night.
`
}, {
    date: '10/14',
    blank: true,
