const diary1Entries = [{
    date: '9-19-2016',
    text: `Loved the interview with Paula in the paper today. She talked about why she wanted to do Pygmalion instead of My Fair Lady, which everyone knows a little better. She hinted at our dearth of fine singers at the moment (although that didn’t exactly stop Rex Harrison), so we’re getting the pure Shaw treatment. She’s so good at making the case why our little city needs our little community theater program. Stupid city with their stupid budget cuts. Right now it looks like the second weekend of shows is going to be cancelled unless someone drums up a lot of cash. There’s still time. I hope.`
}, {
    date: '9-20-2016',
